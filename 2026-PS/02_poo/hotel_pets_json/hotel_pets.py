...
bruno de paula
26 05 2026
fazer um codigo para um hotel com banco de dados json
...
class Pet:
    def __init__(self, nome, especie, idade ,dataNasc, peso, nome_dono, vacinado, hospedado=False):
        self.nome = nome
...
def cadastrar_pet(lista_pets):
    ...
    pet = Pet(nome, especie, idade,dataNasc, peso, nome_dono, vacinado)
    lista_pets.append(pet)
